...
uploaded_file = st.file_input("Upload Foto Uji", type=["jpg", "jpeg", "png"])
...
if uploaded_file is not None:
    ...
    with col2:
        ...
        st.image("v8_out.jpg", caption=f"Hasil YOLOv8 ({t_v8} ms)", use_column_width=True)
    ...
    with col3:
        ...
        st.image("v11_out.jpg", caption=f"Hasil YOLO11 ({t_v11} ms)", use_column_width=True)